...
def main() -> None:
    ...
    owl_gen = OwlSchemaGenerator(str(SCHEMA), **gen_args)
    ...
    shacl_gen = ShaclGenerator(str(SCHEMA), closed=True, **gen_args)
    ...
    ctx_gen = ContextGenerator(
        str(SCHEMA), mergeimports=False, xsd_anyuri_as_iri=True, **gen_args
    )
