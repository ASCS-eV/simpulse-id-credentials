...
Defined in [`linkml/simpulseid.yaml`](https://github.com/ASCS-eV/credentials/blob/main/linkml/simpulseid.yaml) (class `SimpulseidAdministrator`) and [`linkml/simpulseid-credentials.yaml`](https://github.com/ASCS-eV/credentials/blob/main/linkml/simpulseid-credentials.yaml) (class `AdministratorCredential`).
